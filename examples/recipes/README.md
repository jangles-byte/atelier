...
![press and hover](https://github.com/jangles-byte/atelier/releases/download/media/recipes-press-hover.gif) · [source](press-hover.html)
...
![modal](https://github.com/jangles-byte/atelier/releases/download/media/recipes-modal.gif) · [source](modal.html)

### Drawer
Edge-anchored, so it travels from its edge. 450ms open, 360ms close.

![drawer](https://github.com/jangles-byte/atelier/releases/download/media/recipes-drawer.gif) · [source](drawer.html)
...
![dropdown](https://github.com/jangles-byte/atelier/releases/download/media/recipes-dropdown.gif) · [source](dropdown.html)
...
![toast stack](https://github.com/jangles-byte/atelier/releases/download/media/recipes-toast.gif) · [source](toast.html)
...
![accordion](https://github.com/jangles-byte/atelier/releases/download/media/recipes-accordion.gif) · [source](accordion.html)
...
![tabs](https://github.com/jangles-byte/atelier/releases/download/media/recipes-tabs.gif) · [source](tabs.html)

### List reorder (FLIP)
Measure first, mutate, measure last, invert, play. Reorders move together at 300ms so the
swap reads as one event.

![list reorder](https://github.com/jangles-byte/atelier/releases/download/media/recipes-flip-list.gif) · [source](flip-list.html)
...
![drag with snap-back](https://github.com/jangles-byte/atelier/releases/download/media/recipes-drag-snapback.gif) · [source](drag-snapback.html)
...
![number ticker](https://github.com/jangles-byte/atelier/releases/download/media/recipes-number-ticker.gif) · [source](number-ticker.html)
...
![route transition](https://github.com/jangles-byte/atelier/releases/download/media/recipes-route-transition.gif) · [source](route-transition.html)
...
![shared element](https://github.com/jangles-byte/atelier/releases/download/media/expand.gif) · [source](../expand.html)
...
![scroll reveal](https://github.com/jangles-byte/atelier/releases/download/media/recipes-scroll-reveal.gif) · [source](scroll-reveal.html)
...
![parallax](https://github.com/jangles-byte/atelier/releases/download/media/recipes-parallax.gif) · [source](parallax.html)
...
![skeleton to content](https://github.com/jangles-byte/atelier/releases/download/media/recipes-skeleton.gif) · [source](skeleton.html)
...
![progress states](https://github.com/jangles-byte/atelier/releases/download/media/recipes-progress.gif) · [source](progress.html)
...
![spring damping ratios](https://github.com/jangles-byte/atelier/releases/download/media/recipes-spring-damping.gif) · [source](spring-damping.html)
...
![particles](https://github.com/jangles-byte/atelier/releases/download/media/recipes-particles.gif) · [source](particles.html)
...
![screen shake](https://github.com/jangles-byte/atelier/releases/download/media/recipes-screen-shake.gif) · [source](screen-shake.html)

### Hit-stop
70ms at 5% speed on contact. The pause *is* the punch — and freezing to 5% rather than 0
keeps it feeling alive.

![hit-stop](https://github.com/jangles-byte/atelier/releases/download/media/recipes-hit-stop.gif) · [source](hit-stop.html)
...
![chase camera](https://github.com/jangles-byte/atelier/releases/download/media/recipes-chase-camera.gif) · [source](chase-camera.html)

### Ambient field
Generative motion at sub-perceptual speed, where colour is earned by velocity.

![ember](https://github.com/jangles-byte/atelier/releases/download/media/ember.gif) · [source](../ember.html)
